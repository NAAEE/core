...
<h2>Domain Move</h2>
Set up temporary domains pointing at the new server. Example: new.EEinGeorgia.org<br><br>
Add these domains to DomainLookup table.<br><br>
Coordinated with sites on move of externally hosted domain names.<br><br>
Update code to redirect to these domains so sites are reachable while states update their DNS for new IP address.

<strong>Time:</strong>&nbsp;8-20 hrs  
